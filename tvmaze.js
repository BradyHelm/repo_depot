...
async function getShowsByTerm(term) {
  const response = await $.getJSON (`https://api.tvmaze.com/search/shows?q=${term}`);
...
async function getEpisodesOfShow(id) {
  const response = await $.getJSON(`http://api.tvmaze.com/shows/${id}/episodes`);
...
/** Given a list of episodes, create markup for each and add it to DOM */
