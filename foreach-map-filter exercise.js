...
number of times the vowel appears in the string. This function should be 
...
function valTimesIndex(arr, idx, value){
    return arr.map(function(idx, val){
        return val * idx
    })
...
/*
Write a function called filterByValue which accepts an
...
the same value as the second parameter or undefined if the value is not found in the array.
