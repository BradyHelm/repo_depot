...
function vowelCount(str) {
    ...
    return str.split('').reduce(function(accumulator, nextValue){
        ...
        if(vowels.indexOf(lowerCased) !== -1) {
            accumulator[lowerCased] = (accumulator[lowerCased] || 0) + 1;
        }
         return accumulator; 
    },[]); 
    }
...
// could not solve on my own, looked for references, could not find material that matched the leel of the solutions. Please Advise.